...
// /
// / Credit: https://gist.github.com/Necroforger/8b0b70b1a69fa7828b8ad6387ebb3835
// /
...
// SetTimestamp
func (e *Embed) SetTimestamp(timedate time.Time) *Embed {
	e.Timestamp = timedate.Format(time.RFC3339)
	return e
}
