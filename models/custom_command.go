...
var CustomCommandTableColumns = struct {
	...
	AddedByUserID: "custom_command.added_by_user_id",
	GuildID:       "custom_command.guild_id",
	CommandName:   "custom_command.command_name",
	Message:       "custom_command.message",
	CreatedAt:     "custom_command.created_at",
	UpdatedAt:     "custom_command.updated_at",
}
...
func (r *customCommandR) GetGuild() *DiscordServer {
	if r == nil {
		return nil
	}
	return r.Guild
...
var (
	...
	customCommandColumnsWithoutDefault = []string{"added_by_user_id", "guild_id", "command_name", "message"}
...
func CustomCommands(mods ...qm.QueryMod) customCommandQuery {
	...
	if len(queries.GetSelect(q)) == 0 {
		queries.SetSelect(q, []string{"\"custom_command\".*"})
	}
...
func FindCustomCommand(ctx context.Context, exec boil.ContextExecutor, iD int64, selectCols ...string) (*CustomCommand, error) {
	...
	if err = customCommandObj.doAfterSelectHooks(ctx, exec); err != nil {
		return customCommandObj, err
	}
