...
var (
	chatHistoryDBTypes = map[string]string{`ID`: `bigint`, `UserID`: `text`, `UsernameAtTime`: `text`, `GuildID`: `text`, `GuildNameAtTime`: `text`, `GuildChannelID`: `text`, `GuildChannelNameAtTime`: `text`}
	_                  = bytes.MinRead
)
