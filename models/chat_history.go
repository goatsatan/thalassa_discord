...
var (
	chatHistoryAllColumns            = []string{"id", "user_id", "username_at_time", "guild_id", "guild_name_at_time", "guild_channel_id", "guild_channel_name_at_time"}
	...
	chatHistoryColumnsWithDefault    = []string{"id"}
