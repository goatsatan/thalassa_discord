...
var (
	...
	mutedMemberColumnsWithoutDefault = []string{"user_id", "guild_id", "expires_at"}
	mutedMemberColumnsWithDefault    = []string{"id", "created_at"}
	mutedMemberPrimaryKeyColumns     = []string{"id"}
)

type (
	// MutedMemberSlice is an alias for a slice of pointers to MutedMember.
	// This should generally be used opposed to []MutedMember.
...
func MutedMembers(mods ...qm.QueryMod) mutedMemberQuery {
	...
	return mutedMemberQuery{NewQuery(mods...)}
}
